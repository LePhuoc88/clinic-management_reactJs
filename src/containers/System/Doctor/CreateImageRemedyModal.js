...
class CreateImageRemedyModal extends Component {
    ...
    render() {
        let { isOpenCreateImageRemedyModal, closeCreateImageRemedyModal, dataModalCreateRemedy, createRemedyImage } =
            this.props;
        ...
        return (
            <Modal isOpen={isOpenCreateImageRemedyModal} className={'booking-modal-container'} size="xl">
                                                ...
                                                <div class="col-12 form-group">
                                                    <div class="row align-item-center text-center">
                                                        ...
                                                        <div class="col-1 d-flex align-items-center">
                                                            <i
                                                                onClick={() => this.removeDrugFromTheList(drug.id)}
                ...
                <ModalFooter>
                    <Button color="primary" onClick={() => this.handleCreateRemedyImage()}>
                        Create
                    </Button>{' '}
...
export default connect(mapStateToProps, mapDispatchToProps)(CreateImageRemedyModal);
